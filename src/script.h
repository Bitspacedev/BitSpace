...
#ifndef H_BITSPACE_SCRIPT
#define H_BITSPACE_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CbitspaceAddress
 */
...
public:
    ...
    // Pre-version-0.6, bitspace always counted CHECKMULTISIGs
