...
#ifndef _BITSPACERPC_H_
#define _BITSPACERPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // bitspace is not connected
...
/**
 * bitspace RPC command dispatcher.
 */
class CRPCTable
{
private:
