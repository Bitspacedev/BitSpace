...
contains(BITSPACE_NEED_QT_PLUGINS, 1) {
    DEFINES += BITSPACE_NEED_QT_PLUGINS
...
# Gross ugly BSX that depends on qmake internals, unfortunately there is no other way to do it.
...
contains(BITSPACE_QT_TEST, 1) {
SOURCES +=   src/qt/test/test_main.cpp \
    src/qt/test/maintests.cpp
HEADERS += src/qt/test/maintests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = bitspace-qt_test
DEFINES += BITSPACE_QT_TEST
  macx: CONFIG -= app_bundle
}

# Input
DEPENDPATH += src src/json src/qt
HEADERS += src/qt/bitspacegui.h \
    ...
    src/qt/bitspaceaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/bitspace.cpp src/qt/bitspacegui.cpp \
    ...
    src/qt/bitspaceaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/bitspacestrings.cpp \
    src/qt/bitspaceamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/bitspace.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/bitspace_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/bitspace-qt.rc
...
windows:RC_FILE = src/qt/res/bitspace-qt.rc
